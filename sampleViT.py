"""
This code is modfied from https://keras.io/examples/vision/image_classification_with_vision_transformer/.
"""
...
def CreateTransformer(network_size, num_classes, shape, x_train):
...
vit_classifier = CreateTransformer(network_size, num_classes, input_shape, x_train)
